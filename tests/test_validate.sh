...
PRIMARY_IFACE=eth0; IPV4_ADDR=192.0.2.1; NETMASK=255.255.255.0; GATEWAY=192.0.2.254; DNS_SERVERS='1.1.1.1'; HOSTNAME=debian; DOMAIN=local; build_cmdline | grep -q 'console=tty0 console=ttyS0,115200n8 ---' && pass kexec
